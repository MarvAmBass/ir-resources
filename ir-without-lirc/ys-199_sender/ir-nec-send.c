...
{
  //uint32_t outPin = 2;             // The Broadcom pin number the signal will be sent on
  ...
  if(argc == 3) {
    uint32_t outPin = (uint32_t) atoi(argv[1]);
    ...
    printf("ir-nec-send <BCM GPIO PIN Number> <BINARY DATA STRING>\n");
    printf("ir-nec-send 2 010001001011101111110000000011110\n");
  }
}
